...
export const BUILT_IN_PROVIDER_TEMPLATES: readonly ProviderTemplate[] = [
  ...
  },
  {
    ...
    displayName: 'MiniMax',
    description:
      'MiniMax\u2019s OpenAI-compatible endpoint. Bearer authentication; the catalog merges whatever MiniMax reports on refresh.',
  ...
  {
    id: 'data-only-compatible',
    displayName: 'Data-only OpenAI-compatible',
    description:
      'A verified data-only compatible default. Bearer authentication and the generic capability defaults \u2014 use this when the Provider ships an OpenAI-shaped surface but Iroha has no per-Provider opinion about its capability set.',
    baseUrl: 'https://api.example.com/v1',
    authHeader: 'authorization',
    authPrefix: 'Bearer ',
    capabilities: {
